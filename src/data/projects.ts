    ...
    photos: [
      {
        ...
        caption: { "pt-BR": "tela inicial com ingressos disponíveis", en: "home screen with available tickets" },
      },
      {
        src: "/images/albums/mepagaai/ticket.jpg",
        caption: { "pt-BR": "detalhes do ingresso e fluxo de compra", en: "ticket details and purchase flow" },
      },
      {
        src: "/images/albums/mepagaai/profile.jpg",
        caption: { "pt-BR": "perfil do usuário", en: "user profile" },
      },
    ],
  },
  {
    ...
    photos: [
      {
        ...
        caption: { "pt-BR": "ícone do app de controle", en: "control app icon" },
      },
      {
        src: "/images/albums/tcc/nodemcu.jpg",
        caption: { "pt-BR": "pinagem do NodeMCU usado no projeto", en: "NodeMCU pinout used in the project" },
      },
    ],
  },
  {
